...
void Colours::setColors(const char *set)
{
    ...
    else if(strncasecmp(set,"10",2) == 0 || strncasecmp(set, "znf", 3) == 0)
    {
        Color darkgrey1 =  Color(0.5, 0.5, 0.5, "Darkgrey");
	Color darkgrey2 =  Color(0.3, 0.3, 0.3, "Darkgrey");
	
        Color lightgrey1 = Color(0.92, 0.92, 0.92, "Lightgrey1");        
        Color lightgrey2 = Color(0.85, 0.85, 0.85, "Lightgrey2");
	
	Color red   =  Color(1.0, 0.0, 0.0, "Red");
	Color green =  Color(0.0, 1.0, 0.0, "Green");
	Color blue  =  Color(0.0, 0.0, 1.0, "Blue");


	// Foreground color
        this->default_foreground_color = white;

	// Species edge colors
        this->species_edge_color = lightgrey1;
	this->species_edge_contour_color = black;
	this->species_node_color = white;
        this->species_node_contour_color = white;
        
        // Gene edge color
        this->gene_edge_color = lightgrey2;
	this->gene_edge_highlight_color = black;
        	

        // Events color
        this->gene_dupl_color = black;    //red;
	this->gene_spec_color = black;     //blue;
	this->gene_lgt_color  = black;        
    ...
    else if(strncasecmp(set,"11",2) == 0 || strncasecmp(set, "heat", 4) == 0)
    {
        Color darkgrey1 =  Color(0.5, 0.5, 0.5, "Darkgrey");
	Color darkgrey2 =  Color(0.3, 0.3, 0.3, "Darkgrey");
	
        Color lightgrey1 = Color(0.90, 0.90, 0.90, "Lightgrey1");        
        Color lightgrey2 = Color(0.85, 0.85, 0.85, "Lightgrey2");
