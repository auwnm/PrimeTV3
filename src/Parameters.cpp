...
Parameters::Parameters()
{
    ...
    leafwidth = 5;
    leafwidth_dup_scale = 55; // default = 5.0;
    leafwidth_spe_scale = 25; // default = 10.0;
 
    equalTimes = true;
    linewidth = 1.0;	   //4.0 set width for gene
    s_contour_width = 5.0;
    separation = 150.0;  //150.0
    root_sep = 50.0;
    min_node_height = 3;
    maxLeafNameSize = 0.0;
    speciesFontColor.blue = 0.0; //0.0
    speciesFontColor.green = 0.0;
    speciesFontColor.red = 0.0; //0.0
